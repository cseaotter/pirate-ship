...
public class Weapon implements Serializable
{
	...
	/**
	 * @param o another weapon to compare
	...
	public boolean equals(Weapon o)
	{
		...
		result = result && (loc != null && loc.equals(o.loc) || loc == null && o.bulletLoc == null);
		result = result
				&& (bulletLoc != null && bulletLoc.equals(o.bulletLoc) || bulletLoc == null && o.bulletLoc == null);
	 ...
	 * Set location
	 * 
	 * @param loc the point of the location
	 */
	 ...
	 * 
	 * @param bulletLoc the point to set
	 */
	 ...
	 * 
	 * @param bulletActive the boolean to set
	 */
	 ...
	 * 
	 * @param action the turning of the canon
	 */
	 ...
	 * 
	 * @param remoteHealth the health to set
	 */
	 ...
	 * 
	 * @param bulletExplosion true if there is
	 */
	 ...
	 * 
	 * @param explosionFrame the frame number of the explosion
	 */
