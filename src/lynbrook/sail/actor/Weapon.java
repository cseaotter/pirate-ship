...
public class Weapon
{
	...
	public Weapon(IslandMap tm, double pos, double pos2, double speed, double speed2, double damage, boolean right,
			boolean up)
	{
		map = tm;
		xPos = pos;
	 ...
	 * if(xPos-a.getXPos()<safe&&yPos-a.getYPos()<safe) hasHit=true; return hasHit;
	 * }
	 */
	/**
